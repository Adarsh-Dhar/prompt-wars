...
export class SignalGenerator {
    constructor(fearGreedSellThreshold = 60, extremeConditionThreshold = 80, bullishReinforcementThreshold = 70, bearishReinforcementThreshold = 30) {
     ...
     */
    processContrarianLogic(sentimentData) {
        var _a, _b;
        ...
        let confidence = this.calculateConfidence(fearGreedValue, (_a = sentimentData.communityData) === null || _a === void 0 ? void 0 : _a.bullishPercentage);
        ...
        confidence = this.applySentimentReinforcement(confidence, signalType, (_b = sentimentData.communityData) === null || _b === void 0 ? void 0 : _b.bullishPercentage);
     ...
     */
    calculateConfidence(fearGreed, community) {
     ...
     */
    determineExtremeConditions(fearGreed) {
     ...
     */
    applySentimentReinforcement(baseConfidence, signalType, communityBullish) {
     ...
     */
    calculateCommunityAlignment(fearGreed, communityBullish) {
     ...
     */
    generateReasoningText(sentimentData, signalType, confidence, isExtremeCondition) {
        const fearGreedValue = sentimentData.fearGreedIndex.value;
     ...
     */
    generateContrarianSignal(sentimentData, agentId, marketPrice) {
        var _a;
        ...
        return {
            ...
            triggerConditions: {
                ...
                communityBullish: (_a = sentimentData.communityData) === null || _a === void 0 ? void 0 : _a.bullishPercentage,
     ...
     */
    validateSignalParameters(fearGreed, community) {
